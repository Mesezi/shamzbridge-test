...
const Hero = () => {
  return (
    <div className=''>
      <div className='custom-container mx-auto grid grid-cols-1 md:grid-cols-[55%,1fr] lg:grid-cols-[45%,1fr]
      ...
      <section className='flex flex-col gap-4 justify-center md:text-lg pt-32 md:pt-0'>
       ...
       <Reveal delay={.5} from="bottom">
        <div className='flex gap-6 items-center font-medium mt-7 text-sm'>
            <button className='bg-black px-4 py-3 w-full max-w-[130px] text-white hover:scale-[.95]
             hover:text-black hover:bg-customBlue duration-200 ease-in-out font-normal'>
                Get started</button>
            <button className='hover:text-customBlue hover:scale-[.95] flex items-center gap-1  duration-200 ease-in-out'><MdLocalPhone  /> Contact Us</button>
        </div>
        </Reveal>
       </div>
...
<div className='w-[300px] aspect-[1.6/2] md:aspect-[1.4/2] bg-customBlue z-20 text-black self-start'>
   ...
   <Image src={'/vector/star.png'} alt='star' fill className='object-cover object-bottom'/>
        ...
        <div className='w-full ml-auto h-full lg:h-[85%] self-end'> 
          ...
          <Reveal from='right' className='relative h-full w-full'>
          <Image 
        src={'/images/lady-hero2.png'}
        alt=''
        className='object-contain object-right-bottom duration-200  ease-linear'
        fill/>
          </Reveal>
